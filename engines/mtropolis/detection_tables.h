...
#ifdef _DEBUG
#define ADGF_UNSUPPORTED ADGF_UNSTABLE
#endif
...
static const MTropolisGameDescription gameDescriptions[] = {
	...
	{ // I Can Be a Dinosaur Finder - Demo (English, Windows)
	  // Published by Macmillan, 1998
		...
		"WBDFS" //Demo shares directory with idoctor demo
	},
	...
	{ // I Can Be an Animal Doctor - Demo (English, Windows)
	  // Published by Macmillan, 1998
		...
		0,
		MTBOOT_IDINO_DEMO_EN,
		"VETS" //Demo shares directory with idino demo
	},
